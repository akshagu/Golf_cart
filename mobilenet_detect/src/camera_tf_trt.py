...
DEFAULT_LABELMAP = '/home/ubuntu/catkin_ws/src/mobilenet_detect/src/third_party/models/research/mlperf_object_detection/Mask_RCNN/object_detection/data/mscoco_label_map.pbtxt'
##'third_party/models/research/object_detection/data/mscoco_label_map.pbtxt'
...
def parse_args():
    ...
    parser.add_argument('--confidence', dest='conf_th',
                        help='confidence threshold [0.7]',
                        default=0.7, type=float)
    args = parser.parse_args()
    return args


rospy.init_node('mobilenet', argv=sys.argv, anonymous=False)
sys.argv = rospy.myargv(argv=sys.argv)
image_pub1 = rospy.Publisher("cv_test_image",Image, queue_size=1)
image_pub2 = rospy.Publisher("cv_test_box",cvboxarray, queue_size=1)
...
pb_path = '/home/ubuntu/catkin_ws/src/mobilenet_detect/src/data/{}_trt.pb'.format(args.model)
log_path = '/home/ubuntu/catkin_ws/src/mobilenet_detect/src/logs/{}_trt'.format(args.model)
if args.do_build:
...
class image_converter:
  ...
  image_sub = rospy.Subscriber("/v4l/camera/image_raw",Image,callback,queue_size=1)
